...
export const initSettings: settingsType = {
  ...
  library_cleanup: false,
  permissions_change: false,
  storage_cleaner: false,
  tidy_directories: false,
  queue_cleaner_loop: 10,
  content_search_loop: 240,
  failed_cleanup_loop: 60,
  library_cleanup_loop: 60,
  library_cleanup_level: "Import List",
  permissions_change_loop: 10,
  permissions_change_chown: "",
  permissions_change_chmod: "",
  storage_cleaner_loop: 60,
